...
"""
QC input spreadsheet
"""
plants_ungulateInsect = allplants[allplants.Ungulate_Grazed == 'Insect']
plants_ungulateUngrazed = allplants[allplants.Ungulate_Grazed == 'Ungrazed']
print('Insect entries in columns Ungulate_Grazed: {}'.format(sum(allplants.Ungulate_Grazed == 'Insect')))
print('Ungrazed entries in columns Ungulate_Grazed: {}'.format(sum(allplants.Ungulate_Grazed == 'Ungrazed')))
print('Years with Insect entries in Ungulate_Grazed: {}'.format(plants_ungulateInsect.YEAR.unique()))
print('Years with Ungrazed entries in Ungulate_Grazed: {}'.format(plants_ungulateUngrazed.YEAR.unique()))
plants13 = allplants[allplants.YEAR == 2013]
plants12 = allplants[allplants.YEAR == 2012]
plants12.head()
allplants.groupby(['Ungulate_Grazed','Insect_Grazed', 'Grazed']).size().reset_index().rename(columns={0:'count'})
